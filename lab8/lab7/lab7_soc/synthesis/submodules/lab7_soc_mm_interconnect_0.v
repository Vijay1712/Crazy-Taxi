...
module lab7_soc_mm_interconnect_0 (
	...
	wire          cmd_mux_001_src_valid;                                                              // cmd_mux_001:src_valid -> sdram_pll_pll_slave_agent:cp_valid
	wire  [103:0] cmd_mux_001_src_data;                                                               // cmd_mux_001:src_data -> sdram_pll_pll_slave_agent:cp_data
	wire          cmd_mux_001_src_ready;                                                              // sdram_pll_pll_slave_agent:cp_ready -> cmd_mux_001:src_ready
	wire    [7:0] cmd_mux_001_src_channel;                                                            // cmd_mux_001:src_channel -> sdram_pll_pll_slave_agent:cp_channel
	wire          cmd_mux_001_src_startofpacket;                                                      // cmd_mux_001:src_startofpacket -> sdram_pll_pll_slave_agent:cp_startofpacket
	wire          cmd_mux_001_src_endofpacket;                                                        // cmd_mux_001:src_endofpacket -> sdram_pll_pll_slave_agent:cp_endofpacket
	...
	wire  [104:0] reset_s1_agent_rf_source_data;                                                      // reset_s1_agent:rf_source_data -> reset_s1_agent_rsp_fifo:in_data
	...
	wire  [104:0] reset_s1_agent_rsp_fifo_out_data;                                                   // reset_s1_agent_rsp_fifo:out_data -> reset_s1_agent:rf_sink_data
	...
	wire  [103:0] cmd_mux_006_src_data;                                                               // cmd_mux_006:src_data -> reset_s1_agent:cp_data
	wire          cmd_mux_006_src_ready;                                                              // reset_s1_agent:cp_ready -> cmd_mux_006:src_ready
	wire    [7:0] cmd_mux_006_src_channel;                                                            // cmd_mux_006:src_channel -> reset_s1_agent:cp_channel
	...
	wire          sdram_pll_pll_slave_agent_rp_valid;                                                 // sdram_pll_pll_slave_agent:rp_valid -> router_003:sink_valid
	wire  [103:0] sdram_pll_pll_slave_agent_rp_data;                                                  // sdram_pll_pll_slave_agent:rp_data -> router_003:sink_data
	wire          sdram_pll_pll_slave_agent_rp_ready;                                                 // router_003:sink_ready -> sdram_pll_pll_slave_agent:rp_ready
	wire          sdram_pll_pll_slave_agent_rp_startofpacket;                                         // sdram_pll_pll_slave_agent:rp_startofpacket -> router_003:sink_startofpacket
	wire          sdram_pll_pll_slave_agent_rp_endofpacket;                                           // sdram_pll_pll_slave_agent:rp_endofpacket -> router_003:sink_endofpacket
	...
	wire  [103:0] reset_s1_agent_rp_data;                                                             // reset_s1_agent:rp_data -> router_008:sink_data
	...
	wire          sdram_pll_pll_slave_agent_rdata_fifo_src_valid;                                     // sdram_pll_pll_slave_agent:rdata_fifo_src_valid -> avalon_st_adapter_001:in_0_valid
	wire   [33:0] sdram_pll_pll_slave_agent_rdata_fifo_src_data;                                      // sdram_pll_pll_slave_agent:rdata_fifo_src_data -> avalon_st_adapter_001:in_0_data
	wire          sdram_pll_pll_slave_agent_rdata_fifo_src_ready;                                     // avalon_st_adapter_001:in_0_ready -> sdram_pll_pll_slave_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_001_out_0_valid;                                                  // avalon_st_adapter_001:out_0_valid -> sdram_pll_pll_slave_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_001_out_0_data;                                                   // avalon_st_adapter_001:out_0_data -> sdram_pll_pll_slave_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_001_out_0_ready;                                                  // sdram_pll_pll_slave_agent:rdata_fifo_sink_ready -> avalon_st_adapter_001:out_0_ready
	wire    [0:0] avalon_st_adapter_001_out_0_error;                                                  // avalon_st_adapter_001:out_0_error -> sdram_pll_pll_slave_agent:rdata_fifo_sink_error
